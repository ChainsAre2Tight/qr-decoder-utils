...
var QR_CODES = []*qr.QR{
	&qr.QR{Name: "QR Version 1", Size: 21, Cci: qr.CCI1dash9, AlignmentPatterns: []int{}},
	&qr.QR{Name: "QR Version 2", Size: 25, Cci: qr.CCI1dash9, AlignmentPatterns: []int{6, 18}},
	&qr.QR{Name: "QR Version 3", Size: 29, Cci: qr.CCI1dash9, AlignmentPatterns: []int{6, 22}},
	&qr.QR{Name: "QR Version 4", Size: 33, Cci: qr.CCI1dash9, AlignmentPatterns: []int{6, 26}},
}
